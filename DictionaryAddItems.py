...
Add at least three more key-value pairs to the menu variable, with the dish name (as a
"string") for the key and the price (a float or integer) as the value. Here's an example:
...
menu['Macaroni and Cheese'] = 7.95
menu['Pickled Herring'] = 10.26
menu['Red Snapper'] = 15.95
