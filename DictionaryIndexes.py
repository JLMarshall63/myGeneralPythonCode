...
This is a dictionary called d with three key-value pairs. The key 'key1' points to the value
1, 'key2' to 2, and so on.
...
values by key is just like accessing list values
'''
